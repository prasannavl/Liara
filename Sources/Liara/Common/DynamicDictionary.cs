...
namespace Liara.Common
{
        ...
        IDictionary<string, object>
    {
        ...
        public DynamicDictionary(bool isCaseSensitive = false)
        {
            dictionary =
                new Dictionary<string, dynamic>(isCaseSensitive
        ...
        public bool Contains(KeyValuePair<string, dynamic> item)
        {
            ...
            return dictionary.Contains(dynamicValueKeyValuePair);
        }
        ...
        public bool Remove(KeyValuePair<string, dynamic> item)
        {
            ...
            return dictionary.Remove(dynamicValueKeyValuePair);
        }
        ...
        public static DynamicDictionary Create(IDictionary<string, object> values, bool isCaseSensitive = false)
        {
            var instance = new DynamicDictionary(isCaseSensitive);
